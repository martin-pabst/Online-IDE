    ...
    */
    ...
    function locale (locale) {
        ...
        $.ajax({
            ...
            type     : "GET",
            dataType : "JSON",
            //Martin Pabst, 24.01.2021: This caused an error in Chrome, so i set it to true:
            async    : true,
            ...
            if (this.toolbar['render'] == null) {
                ...
                if (this.show.toolbarInput) {
                    var html =
                        ...
                        '    <td>'+
                        '        <input type="text" id="grid_'+ this.name +'_search_all" class="w2ui-search-all" tabindex="-1" autocomplete="off"'+
        ...
        generateHTML: function () {
            ...
            for (var f = 0; f < this.fields.length; f++) {
                ...
                switch (field.type) {
                    case 'pass':
                    case 'password':
                        input = '<input name="' + field.name + '" class="w2ui-input" type = "password" autocomplete="new-password"' + field.html.attr + ' tabindex="'+ (f+1) +'"/>';
                        break;
                    case 'checkbox':
