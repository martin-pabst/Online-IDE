...
export type AccordionElementNew = {
    name: string;
...
export type AccordionContextMenuItemNew = {
    caption: string;
    color?: string;
    callback: (panel: AccordionElementNew) => void;
    subMenu?: AccordionContextMenuItemNew[]
}

export class AccordionPanelNew {

    elements: AccordionElementNew[] = [];
    ...
    newElementCallback: (ae: AccordionElementNew, callbackIfSuccessful: (externalElement: any) => void) => void;
    ...
    addElementActionCallback: (accordionElementNew: AccordionElementNew) => JQuery<HTMLElement>;
    contextMenuProvider: (externalElement: any) => AccordionContextMenuItemNew[];

    constructor(private accordion: AccordionNew, private caption: string, private flexWeight: string,
    ...
    addElement(element: AccordionElementNew) {
    ...
    setTextAfterFilename(element: AccordionElementNew, text: string, cssClass: string) {
    ...
    renderElement(element: AccordionElementNew): JQuery<HTMLElement> {
    ...
    renameElement(element: AccordionElementNew, callback?: () => void) {
        let that = this;
    ...
    setElementClass(element: AccordionElementNew, iconClass: string){
        if(element != null){
    ...
    findElement(externalElement: any): AccordionElementNew {
...
export class AccordionNew {
    ...
    addPanel(panel: AccordionPanelNew) {
